      ...
      <div className="hero-container">
        ...
        >
          <motion.h1
            ...
            style={{
              textShadow: '0 0 20px rgba(0,0,0,0.9), 0 0 40px rgba(0,0,0,0.7), 2px 2px 8px rgba(0,0,0,1)'
            }}
          >
            CODEFORGE
          </motion.h1>
          <motion.p
            ...
            style={{
              textShadow: '0 0 15px rgba(0,0,0,0.8), 0 0 30px rgba(0,0,0,0.6), 1px 1px 6px rgba(0,0,0,0.9)'
            }}
          >
            Your ideas forged into{" "}
            <span className="typing-text text-orange-400 font-semibold drop-shadow-lg"
              style={{
                textShadow: '0 0 20px rgba(255,127,0,0.8), 0 0 40px rgba(255,127,0,0.4), 2px 2px 8px rgba(0,0,0,1)'
              }}>
              {typedText}
            </span>
            <span className="typing-cursor text-orange-400"
              style={{
                textShadow: '0 0 15px rgba(255,127,0,0.8), 2px 2px 6px rgba(0,0,0,1)'
              }}>
              |
            </span>
          </motion.p>
        ...
        >
          ...
          >
            <div className="scroll-text text-white/90 drop-shadow-lg font-medium"
              style={{
        ...
        <div className="contact-container">
          ...
          >
            ...
            <motion.p className="contact-description" variants={fadeInUp}>
              Ready to transform your ideas into reality? Share your vision with us and let's bring it to life.
            </motion.p>
          </motion.div>
        ...
        <div className="footer-container">
          ...
          <div className="footer-content">
            ...
            >
              ...
              <p className="footer-tagline">
                Forging the future of technology through code, creativity, and boundless imagination.
              </p>
          ...
          >
            ...
            <div className="footer-made-with">
              <p>Made with <span className="heart">❤️</span> by the CodeForge Team</p>
            </div>
          </motion.div>
        </div>
      </footer>
