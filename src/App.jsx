    ...
    <>
      ...
      <div className="hero-container">
        ...
        >
          ...
          >
            Your ideas forged into <span className="typing-text">{typedText}</span><span className="typing-cursor">|</span>
          </motion.p>
        </motion.div>
        ...
        <div className="about-container">
          ...
          >
            ...
            <motion.p className="about-description" variants={fadeInUp}>
              Where innovation meets craftsmanship. We forge the future of technology through code, creativity, and boundless imagination.
            </motion.p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="card-text">
                To empower developers and businesses with cutting-edge solutions that transform ideas into digital reality.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="card-text">
                A world where technology seamlessly enhances human potential and creates meaningful connections.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="card-text">
                Innovation, integrity, and excellence drive everything we do. We believe in building with purpose and passion.
              </p>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: shouldReduceMotion ? 0.3 : 0.7, delay: shouldReduceMotion ? 0 : 0.2, ease: "easeOut" }}
            viewport={{ once: true }}
          >
            <div className="quote-container">
              <svg className="quote-icon quote-icon-left" fill="currentColor" viewBox="0 0 24 24">
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h4v10h-10z" />
              </svg>
              <blockquote className="quote-text">
                "Code is poetry written in logic. At CodeForge, we craft verses that change the world."
              </blockquote>
              <svg className="quote-icon quote-icon-right" fill="currentColor" viewBox="0 0 24 24">
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h4v10h-10z" />
              </svg>
            </div>
            <motion.div
              ...
              transition={{ duration: shouldReduceMotion ? 0.3 : 0.8, delay: shouldReduceMotion ? 0 : 0.3, ease: "easeOut" }}
              viewport={{ once: true }}
            >
        ...
        <div className="services-container">
          ...
          >
            ...
            <motion.p className="services-description" variants={fadeInUp}>
              From concept to deployment, we deliver comprehensive digital solutions that drive growth and innovation for your business.
            </motion.p>
          </motion.div>
          ...
          >
            {[
              ...
              },
              {
                ...
                description: "Scalable cloud infrastructure and DevOps solutions that ensure reliability, security, and performance.",
              ...
              },
              {
                ...
                description: "Intelligent solutions powered by AI and machine learning to automate processes and unlock insights.",
                features: ["TensorFlow & PyTorch", "Computer Vision", "NLP & ChatBots", "Predictive Analytics"]
              },
              {
              ...
              },
              {
                ...
                features: ["Custom Stores", "Payment Integration", "Inventory Management", "Analytics & Reports"]
              }
            ].map((service, index) => (
              <motion.div
                key={service.title}
              ...
              >
                ...
                <div className="service-features">
                  {service.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="service-feature">{feature}</div>
                  ))}
                </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: shouldReduceMotion ? 0.3 : 0.8, delay: shouldReduceMotion ? 0 : 0.2, ease: "easeOut" }}
            viewport={{ once: true }}
          >
            <div className="services-cta-container">
              <h3 className="services-cta-title">Ready to Transform Your Ideas?</h3>
              <p className="services-cta-description">
                Let's discuss how we can bring your vision to life with our cutting-edge solutions.
              </p>
              <motion.button
                className="services-cta-button"
                initial={{ scale: 0.9, opacity: 0 }}
                whileInView={{ scale: 1, opacity: 1 }}
                transition={{ duration: shouldReduceMotion ? 0.2 : 0.5, delay: shouldReduceMotion ? 0 : 0.3, ease: "easeOut" }}
                viewport={{ once: true }}
                whileHover={shouldReduceMotion ? {} : {
                  scale: 1.05,
        ...
        <div className="testimonials-container">
          ...
          >
            ...
            <motion.p className="testimonials-description" variants={fadeInUp}>
              Hear from the innovators, entrepreneurs, and visionaries who have trusted CodeForge to bring their ideas to life.
            </motion.p>
          </motion.div>
            ...
            {[
              {
                ...
                avatar: "SC",
                rating: 5,
                testimonial: "CodeForge transformed our vision into a stunning web application that exceeded all expectations. Their attention to detail and innovative approach helped us launch ahead of schedule.",
              ...
              },
              {
                ...
                avatar: "MR",
                rating: 5,
                testimonial: "Working with CodeForge was a game-changer. They delivered a robust mobile app that perfectly captured our brand identity and user experience goals.",
              ...
              },
              {
                ...
                avatar: "EW",
                rating: 5,
                testimonial: "The team's expertise in AI and machine learning helped us create solutions we never thought possible. Truly exceptional work and communication throughout.",
              ...
              },
              {
                ...
                avatar: "DK",
                rating: 5,
                testimonial: "CodeForge's cloud infrastructure solutions scaled our business seamlessly. Their DevOps expertise saved us months of development time.",
              ...
              },
              {
                ...
                avatar: "JT",
                rating: 5,
                testimonial: "The UI/UX design work was absolutely brilliant. They understood our vision and created an interface that our users love and our team is proud of.",
              ...
              },
              {
                ...
                avatar: "AB",
                rating: 5,
                testimonial: "Our online sales increased by 300% after launching the new e-commerce platform. CodeForge delivered beyond our wildest expectations.",
              ...
              >
                ...
                <div className="testimonial-rating">
                  {[...Array(testimonial.rating)].map((_, starIndex) => (
                    <motion.svg
                      ...
                      transition={{ delay: 0.1 + starIndex * 0.1, duration: 0.3 }}
                      viewport={{ once: true }}
                    >
                ...
                <div className="testimonial-project">
                  <svg className="testimonial-project-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="testimonial-author">
                  <div className="testimonial-avatar">
                    <div className="testimonial-avatar-bg">
                      <span className="testimonial-avatar-text">{testimonial.avatar}</span>
                    </div>
                  </div>
                  <div className="testimonial-author-info">
                    ...
                    <div className="testimonial-company">
                      <svg className="testimonial-company-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="testimonials-cta-container">
              <h3 className="testimonials-cta-title">Ready to Join Our Success Stories?</h3>
              <p className="testimonials-cta-description">
                Let's create something amazing together and add your story to our collection of successful projects.
              </p>
              <motion.button
      ...
      >
        <div className="extra-container">
          <motion.h2
            ...
            transition={{ duration: shouldReduceMotion ? 0.3 : 0.6, delay: shouldReduceMotion ? 0 : 0.1 }}
            viewport={{ once: true }}
          >
            More Content
          </motion.h2>
          <motion.p
            ...
            viewport={{ once: true }}
          >
            This extra section ensures we have enough content to scroll and test the navbar functionality.
          </motion.p>
        </div>
      </motion.div>
    </>
